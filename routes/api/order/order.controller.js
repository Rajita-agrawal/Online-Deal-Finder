...
function createStateMachine(order) {
  ...
  return new StateMachine({
    ...
    transitions: [
      ...
      { name: "en_route", from: "placed", to: "en_route" },
      { name: "en_route", from: "processing", to: "en_route" },

      { name: "arrived", from: "placed", to: "arrived" },
      { name: "arrived", from: "processing", to: "arrived" },
      { name: "arrived", from: "en_route", to: "arrived" },

      { name: "cancelled", from: "placed", to: "cancelled" },
      { name: "cancelled", from: "processing", to: "cancelled" },
      { name: "cancelled", from: "arrived", to: "cancelled" },
      { name: "cancelled", from: "en_route", to: "cancelled" }
